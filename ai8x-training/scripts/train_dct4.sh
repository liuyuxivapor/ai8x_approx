...
python ./train.py --epochs 300 --batch-size 512 --gpus 0 --deterministic --optimizer Adam --lr 0.0001 --compress policies/schedule-dct4.yaml --model ai85net_dct4 --dataset dct4 --regression --param-hist --device MAX78000 "$@"
